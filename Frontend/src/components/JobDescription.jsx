    ...
    return (
        <div className='max-w-7xl mx-auto my-10'>
            ...
            <div className='my-5'>
                ...
                <h1 className='font-bold my-1'>Description: <span className='pl-4 font-normal text-gray-800'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Numquam, vitae asperiores vero placeat corrupti vel!</span></h1>
                ...
                <h1 className='font-bold my-1'>Posted Date: <span className='pl-4 font-normal text-gray-800'>02-09-2025</span></h1>
            </div>
