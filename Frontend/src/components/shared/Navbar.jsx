...
const Navbar = () => {
    ...
    return (
        <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-in-out ${
            ...
            {isMobileMenuOpen && (
                <div className="md:hidden absolute top-full left-0 right-0 bg-white/95 backdrop-blur-xl border-t border-white/20 shadow-xl">
                    <div className="px-4 py-6 space-y-4">
                        {user && user.role === 'recruiter' ? (
                            <>
                                <Link to="/admin/companies" className="block py-3 px-4 text-gray-700 hover:text-purple-600 hover:bg-purple-50 rounded-lg transition-all duration-200">
                                    Companies
                                </Link>
                                <Link to="/admin/jobs" className="block py-3 px-4 text-gray-700 hover:text-purple-600 hover:bg-purple-50 rounded-lg transition-all duration-200">
                                    Jobs
                                </Link>
                            </>
                        ) : (
                            <>
                                <Link to="/" className="block py-3 px-4 text-gray-700 hover:text-purple-600 hover:bg-purple-50 rounded-lg transition-all duration-200">
                                    Home
                                </Link>
                                <Link to="/jobs" className="block py-3 px-4 text-gray-700 hover:text-purple-600 hover:bg-purple-50 rounded-lg transition-all duration-200">
                                    Jobs
                                </Link>
                                <Link to="/browse" className="block py-3 px-4 text-gray-700 hover:text-purple-600 hover:bg-purple-50 rounded-lg transition-all duration-200">
                                    Browse
                                </Link>
                            </>
                        )}
                        ...
                        {!user && (
                            <div className="flex flex-col gap-3 pt-4">
                                <Link to="/login">
                                    <Button variant="outline" className="w-full border-purple-200 hover:border-purple-400">
                                        Login
                                    </Button>
                                </Link>
                                <Link to="/signup">
